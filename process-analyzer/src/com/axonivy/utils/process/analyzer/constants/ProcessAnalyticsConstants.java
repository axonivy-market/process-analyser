package com.axonivy.utils.process.analyzer.constants;
...
public class ProcessAnalyticsConstants {
  ...
  public static final String PROCESS_ANALYZER_PMV_NAME = "process-analyzer";
  ...
  public static final String PROCESS_ANALYZER_SOURCE_URL_PATTERN = "/%s/faces/view/process-analyzer/process-miner.xhtml?server=%s&app=%s&pmv=%s&file=/processes/%s";
  public static final String PROCESS_ANALYZER_CMS_PATH = "process-analyzer";
