...
import static com.axonivy.utils.process.analyser.constants.AnalyserConstants.ANALYSIS_EXCEL_FILE_PATTERN;
import static com.axonivy.utils.process.analyser.constants.AnalyserConstants.MULTIPLE_UNDERSCORES_REGEX;
import static com.axonivy.utils.process.analyser.constants.AnalyserConstants.SPACE_DASH_REGEX;
import static com.axonivy.utils.process.analyser.constants.AnalyserConstants.UNDERSCORE;
import static com.axonivy.utils.process.analyser.core.constants.CoreConstants.HYPHEN_SIGN;
import static com.axonivy.utils.process.analyser.core.enums.StartElementType.START_EVENT_ELEMENT;
import static com.axonivy.utils.process.analyser.core.enums.StartElementType.START_SIGNAL_EVENT_ELEMENT;
import static com.axonivy.utils.process.analyser.core.enums.StartElementType.WEB_SERVICE_PROCESS_START_ELEMENT;
...
import com.axonivy.utils.process.analyser.bo.ProcessViewerConfig;
import com.axonivy.utils.process.analyser.constants.ProcessAnalyticViewComponentId;
import com.axonivy.utils.process.analyser.core.bo.Process;
import com.axonivy.utils.process.analyser.core.bo.StartElement;
import com.axonivy.utils.process.analyser.core.constants.CoreConstants;
import com.axonivy.utils.process.analyser.core.enums.StartElementType;
...
public class MasterDataBean implements Serializable {
  ...
  public String getPmvLabel(IProcessModelVersion pmv) {
    return Ivy.cms().co("/Dialogs/com/axonivy/utils/process/analyser/ProcessesMonitor/Version", List.of(pmv.getVersionNumber()));
  }
