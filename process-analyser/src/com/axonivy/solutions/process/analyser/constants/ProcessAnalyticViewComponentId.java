...
public class ProcessAnalyticViewComponentId {
  ...
  public static final String PROCESS_DROPDOWN = FORM + ID_SECTION_SEPARATOR + "processDropdown";
  ...
  public static final String CUSTOM_FILTER_PANEL = FORM + ID_SECTION_SEPARATOR + "custom-filter-panel";
