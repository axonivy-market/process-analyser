...
public class ProcessAnalyticViewComponentId {
  ...
  public static final String WIDGET_STANDRAD_FILTER = PROCESS_ANALYTIC_VIEWER_PANEL + ID_SECTION_SEPARATOR
      + "standard-filter";
  ...
  public static final String PROCESS_ANALYTIC_VIEWER_PANEL_GROUP = FORM + ID_SECTION_SEPARATOR
  ...
  public static List<String> getDiagramAndStatisticComponentIds() {
    return List.of(HIDDEN_IMAGE, PROCESS_ANALYTIC_VIEWER_PANEL_GROUP, SHOW_STATISTIC_BTN, ACTION_BTN_GROUP,
        DATA_STATISTICS);
  }
}
