package com.axonivy.utils.process.analyser.core.internal;

import static com.axonivy.utils.process.analyser.core.constants.CoreConstants.AND;
import static com.axonivy.utils.process.analyser.core.constants.CoreConstants.SLASH;
import static com.axonivy.utils.process.analyser.core.enums.ViewerParam.*;
...
import com.axonivy.utils.process.analyser.core.enums.ViewerParam;
...
public class ProcessViewerBuilder {
  ...
  private ProcessViewerBuilder addQueryParam(ViewerParam param, String value) {
    queryParams.compute(param, (key, val) -> StringUtils.isBlank(val) ? value : val.concat(AND).concat(value));
    return this;
  }
