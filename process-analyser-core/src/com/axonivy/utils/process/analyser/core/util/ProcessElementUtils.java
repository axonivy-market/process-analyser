package com.axonivy.utils.process.analyser.core.util;

import static com.axonivy.utils.process.analyser.core.enums.ElementType.ALTERNATIVE;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.CALL_SUB_END;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.CALL_SUB_START;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.ELEMENT;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.EMBEDDED_END;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.EMBEDDED_PROCESS_ELEMENT;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.EMBEDDED_START;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.REQUEST_START;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.REST_CLIENT_CALL;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.SCRIPT;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.SCRIPT_BPMN_ELEMENT;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.SERVICE_BPMN_ELEMENT;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.SIGNAL_START_EVENT;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.SUB_PROCESS_CALL;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.TASK_END;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.TASK_SWITCH_EVENT;
import static com.axonivy.utils.process.analyser.core.enums.ElementType.TASK_SWITCH_GATEWAY;
...
import com.axonivy.utils.process.analyser.core.bo.ElementDisplayName;
import com.axonivy.utils.process.analyser.core.enums.ElementType;
import com.axonivy.utils.process.analyser.core.internal.ProcessUtils;
