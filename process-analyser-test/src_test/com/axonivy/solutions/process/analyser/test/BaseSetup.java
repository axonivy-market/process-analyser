...
public class BaseSetup {
  ...
  protected static final String TEST_SELECTED_FILE_PATH_URL = "/processes/SupportHR.p.json";
  protected static final String TEST_IFRAME_SOURCE_URL = "/test/faces/view/process-analyser-test/process-miner.xhtml?server=localhost:8080&app=test&pmv=HRTest&file="
      + TEST_SELECTED_FILE_PATH_URL;
