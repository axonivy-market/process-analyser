...
public class ProcessMonitorConstants {
  public static final String PORTAL_START_REQUEST_PATH = "/DefaultApplicationHomePage.ivp";
  public static final String PORTAL_IN_TEAMS_REQUEST_PATH = "InTeams.ivp";
